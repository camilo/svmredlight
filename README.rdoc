== svmredlight
 ...
 A partial interface to SVM-light [http://svmlight.joachims.org/] it permits loading a
 model (pre-created with svm_learn) from a file and using it for classification and
 training classification SVMs using linear kernels only.
